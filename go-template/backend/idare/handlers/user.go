...
type UserHandler struct {
	base.BaseHandler[model.User, viewmodel.UserCreateVM, viewmodel.UserUpdateVM, viewmodel.UserListVM, viewmodel.UserDetailVM]
	userService service.IUserService
}

func NewUserHandler(s service.IUserService) UserHandler {
	h := UserHandler{
		BaseHandler: base.NewBaseHandler[model.User, viewmodel.UserCreateVM, viewmodel.UserUpdateVM, viewmodel.UserListVM, viewmodel.UserDetailVM](s),
		userService: s,
	}
